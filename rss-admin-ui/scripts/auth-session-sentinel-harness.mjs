...
const network = `rss-admin-ui-ms023b-sentinel-${suffix}`;
const recorderName = `rss-admin-ui-ms023b-recorder-${suffix}`;
const frontendName = `rss-admin-ui-ms023b-runtime-${suffix}`;
