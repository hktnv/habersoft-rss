...
const network = `rss-admin-ui-ms023a-r2-auth-${suffix}`;
const sentinelName = `rss-admin-ui-ms023a-r2-auth-sentinel-${suffix}`;
const frontendName = `rss-admin-ui-ms023a-r2-auth-runtime-${suffix}`;
