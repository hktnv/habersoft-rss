...
const network = `rss-admin-ui-ms026b-auth-${suffix}`;
const sentinelName = `rss-admin-ui-ms026b-auth-sentinel-${suffix}`;
const frontendName = `rss-admin-ui-ms026b-auth-runtime-${suffix}`;
