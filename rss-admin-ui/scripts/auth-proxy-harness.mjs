...
const network = `rss-admin-ui-ms023b-auth-${suffix}`;
const sentinelName = `rss-admin-ui-ms023b-auth-sentinel-${suffix}`;
const frontendName = `rss-admin-ui-ms023b-auth-runtime-${suffix}`;
