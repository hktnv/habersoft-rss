...
const network = `rss-admin-ui-ms026a-auth-${suffix}`;
const sentinelName = `rss-admin-ui-ms026a-auth-sentinel-${suffix}`;
const frontendName = `rss-admin-ui-ms026a-auth-runtime-${suffix}`;
