...
const network = `rss-admin-ui-ms022a-auth-${suffix}`;
const sentinelName = `rss-admin-ui-ms022a-auth-sentinel-${suffix}`;
const frontendName = `rss-admin-ui-ms022a-auth-runtime-${suffix}`;
