...
const network = `rss-admin-ui-ms023c-auth-${suffix}`;
const sentinelName = `rss-admin-ui-ms023c-auth-sentinel-${suffix}`;
const frontendName = `rss-admin-ui-ms023c-auth-runtime-${suffix}`;
