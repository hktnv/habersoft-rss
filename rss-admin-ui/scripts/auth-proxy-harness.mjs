...
const network = `rss-admin-ui-ms026c-auth-${suffix}`;
const sentinelName = `rss-admin-ui-ms026c-auth-sentinel-${suffix}`;
const frontendName = `rss-admin-ui-ms026c-auth-runtime-${suffix}`;
