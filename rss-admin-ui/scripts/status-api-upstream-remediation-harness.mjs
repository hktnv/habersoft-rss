...
const network = `rss-admin-ui-ms026a-networking-${suffix}`;
const internalBackendName = `rss-admin-ui-ms026a-internal-backend-${suffix}`;
const forbiddenBackendName = `rss-admin-ui-ms026a-forbidden-backend-${suffix}`;
