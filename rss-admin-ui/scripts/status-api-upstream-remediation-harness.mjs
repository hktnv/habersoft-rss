...
const network = `rss-admin-ui-ms026c-networking-${suffix}`;
const internalBackendName = `rss-admin-ui-ms026c-internal-backend-${suffix}`;
const forbiddenBackendName = `rss-admin-ui-ms026c-forbidden-backend-${suffix}`;
