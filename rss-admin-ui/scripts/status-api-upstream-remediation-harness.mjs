...
const network = `rss-admin-ui-ms026b-networking-${suffix}`;
const internalBackendName = `rss-admin-ui-ms026b-internal-backend-${suffix}`;
const forbiddenBackendName = `rss-admin-ui-ms026b-forbidden-backend-${suffix}`;
