...
const requiredFiles = [
  ...
  ".docs/operator-automation-acceptance.md",
  ...
  JSON.stringify(
    {
      ...
      admin_ui_state: "SUCCESS_MS_026C_R1_OPERATOR_AUTOMATION_PRODUCTION_ACCEPTANCE_CLOSED_FEED_RECHECK_PENDING_NO_TARGET",
      feed_recheck_effect_state: "PENDING_NO_ELIGIBLE_FEED_RECHECK_TARGET",
...
function assertPackageScripts() {
  ...
  const requiredFrontend = {
    ...
    "verify:operator-automation-acceptance": "node scripts/operator-automation-acceptance-verify.mjs",
...
function assertDocsBoundary() {
  ...
  const required = [
    ...
    "SUCCESS_MS_026C_R1_OPERATOR_AUTOMATION_PRODUCTION_ACCEPTANCE_CLOSED_FEED_RECHECK_PENDING_NO_TARGET",
