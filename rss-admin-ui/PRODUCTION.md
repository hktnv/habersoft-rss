...
MS-027B-R2 adds evidence regression-mode semantics for already-present feed retests while preserving the MS-027B-R1 acceptance ledger. MS-027B-R1 feed onboarding plus recheck effect production acceptance remains accepted. Do not claim a fresh onboarding effect from an already-present feed regression retest.
