...
function assertPolicyDocument() {
  ...
  const requiredFragments = [
    ...
    "Temporary `E:\\Codex\\rss-habersoft-com\\workplace\\ms-...\\` paths are allowed in internal command transcripts",
    "durable operator artifact references",
    "tracked repository path",
    "E:\\Codex\\rss-habersoft-com\\operator-state\\...",
    "Git SHA, branch names, repository-relative paths, durable operator-state receipt paths",
    "must not depend on deleted task roots as operator-facing artifacts",
    "task root removed: true",
    "workplace root preserved: true",
