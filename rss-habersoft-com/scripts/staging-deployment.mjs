...
function preflight() {
  ...
  console.log(JSON.stringify({
    ...
    project_container_total: receipt.project_container_total,
    project_container_running: receipt.project_container_running,
    project_volume_count: receipt.project_volume_count,
    api_port_listener_count: receipt.api_port_listener_count,
