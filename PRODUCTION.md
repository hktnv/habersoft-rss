...
- MS-024A prepares authenticated admin activation inputs and local evidence tooling only; production admin auth remains pending operator backend runtime env placement and `main-service-api` restart/recreate.
